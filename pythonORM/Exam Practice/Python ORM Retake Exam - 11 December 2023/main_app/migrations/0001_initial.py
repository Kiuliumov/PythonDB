    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('surface_type', models.CharField(choices=[('Not Selected', 'Not Selected'), ('Clay', 'Clay'), ('Grass', 'Grass'), ('Hard Court', 'Hard Court')], max_length=12)),
            ],
        ),
        migrations.CreateModel(
            name='Match',
            fields=[
                ...
                ('winner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main_app.tennisplayer')),
