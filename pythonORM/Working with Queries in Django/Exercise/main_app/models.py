...
class Laptop(models.Model):
    brand = models.CharField(max_length=20, choices=[('Asus', 'Asus'), ('Acer', 'Acer'), ('Apple', 'Apple'), ('Lenovo', 'Lenovo'), ('Dell', 'Dell')])
    ...
    operation_system = models.CharField(max_length=20, choices=[('Windows', 'Windows'), ('MacOS', 'MacOS'), ('Linux', 'Linux'), ('Chrome OS', 'Chrome OS')])
    price = models.DecimalField(max_digits=10, decimal_places=2)
